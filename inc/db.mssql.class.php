...
class ms_db
{
        ...
        // Constructor
        //
        function ms_db($db_connect_id , $database)
        {
                $this->dbname = $database;
				$this->db_connect_id = $db_connect_id;
        ...
        // Query method
        //
        function ms_query($query = '', $transaction = FALSE)
        {
                //
        ...
        // Other query methods
        //
        function ms_numrows($query_id = 0)
        {
                if( !$query_id )
                {
        ...
        function ms_numfields($query_id = 0)
        {
                if( !$query_id )
                {
                        $query_id = $this->result;
        ...
        function ms_fieldname($offset, $query_id = 0)
        {
                if( !$query_id )
                {
                        $query_id = $this->result;
        ...
        function ms_fieldtype($offset, $query_id = 0)
        {
                if(!$query_id)
                {
                        $query_id = $this->result;
        ...
        function ms_fetchrow($query_id = 0)
        {
                if( !$query_id )
                {
                        $query_id = $this->result;
        ...
        function ms_fetchrowset($query_id = 0)
        {
                if( !$query_id )
                {
                        $query_id = $this->result;
        ...
        function ms_fetchfield($field, $row = -1, $query_id)
        {
                if( !$query_id )
                {
                        $query_id = $this->result;
        ...
        function ms_rowseek($rownum, $query_id = 0)
        {
                if( !$query_id )
                {
                        $query_id = $this->result;
